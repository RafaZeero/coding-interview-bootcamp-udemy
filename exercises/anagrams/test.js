...
test('School master', () => {
  expect(anagrams('The classroom', 'School master')).toBeTruthy()
})

test('Leonardo da Vince', () => {
  expect(anagrams(' Leonardo Da Vinci', 'O, Draconian devil!')).toBeTruthy()
})

test('Madonna', () => {
  expect(anagrams('Madonna of the Rocks', 'So dark xhe con of Man')).toBeFalsy()
})
